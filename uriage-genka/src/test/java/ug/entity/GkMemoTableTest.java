...
public class GkMemoTableTest extends S2TestCase {
    ...
    public void testFindById() throws Exception {
        jdbcManager.from(GkMemoTable.class).id(1).getSingleResult();
    }
    ...
    public void testLeftOuterJoin_genkaKanri() throws Exception {
        jdbcManager.from(GkMemoTable.class).leftOuterJoin(genkaKanri()).id(1).getSingleResult();
    }
}