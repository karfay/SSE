...
<s:form>
	<table>
		...
		<tr>
			...
			<td><html:text style="ime-mode: disabled; width: 100%;" maxlength="8" property="bringDate" value="${f:h(time)}" errorStyleClass="err" /></td>
			</c:if>
			...
			<td><html:text style="ime-mode: disabled; width: 100%;" maxlength="9" property="bringPerson" value="${f:h(userId)}" errorStyleClass="err" /></td>
			<c:if test = "${empty scheduledDate}">
			<td><html:text style="ime-mode: disabled; width: 100%;" maxlength="8" property="scheduledDate" value="${f:h(time)}" errorStyleClass="err" /></td>
			</c:if>
	...
	<table border="1">
		...
		<tr>
			<td colspan="4"><html:text property="materialName" value="${f:h(materialName)}" style="ime-mode: active; width: 100%;" errorStyleClass="err" /></td>
		</tr>
		<tr>
		</tr>
		<tr>
