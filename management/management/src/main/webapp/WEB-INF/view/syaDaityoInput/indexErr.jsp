...
<s:form>
	<table border="1">
		...
		<tr>
			<td><html:text style="ime-mode: disabled; width: 100%;" errorStyleClass="err"  maxlength="8" property="appDate" value="${f:h(time)}" /></td>
			<td><html:text style="ime-mode: disabled; width: 100%;" errorStyleClass="err"  maxlength="9" property="appUser" value="${f:h(userId)}" /></td>
			<td><html:text style="ime-mode: disabled; width: 100%;" errorStyleClass="err"  maxlength="8" property="startDate" value="${f:h(time)}" /></td>
			<td><html:text style="ime-mode: disabled; width: 100%;" errorStyleClass="err"  maxlength="8" property="endDate" value="${f:h(time)}" /></td>
		</tr>
		<tr>
			<th>持出先</th>
			<td class="none"></td>
		...
		<tr>
			<td colspan="5"><html:text property="project" value="${f:h(project)}" style="ime-mode: active; width: 100%;" errorStyleClass="err" /></td>
		</tr>
	</table>
	<br />
	<br />
	...
	<table border="1">
		...
		<tr>
			<td><html:text style="ime-mode: active; width: 100%;" errorStyleClass="err" property="docName" /></td>
			<td><html:text style="ime-mode: disabled; width: 100%;" errorStyleClass="err" property="copies" /></td>
