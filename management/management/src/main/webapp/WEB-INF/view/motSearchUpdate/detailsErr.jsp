...
<c:forEach var="h" items="${historyDto}">
	...
	<c:if test="${h.conditionCode != -1}">
		...
		<c:if test="${h.processCode == 0}">
			<ul>
			<html:errors property="processPerson" />
			<html:errors property="processDate" />
			<html:errors property="processCode" /></ul>
			<s:form>
				...
				<table border="1">
					...
					<tr>
						<td><html:text styleClass="hankaku" maxlength="9"  property="processPerson" value="${f:h(userId)}" errorStyleClass="err" /></td>
						<td><html:text styleClass="hankaku" maxlength="8" property="processDate" value="${f:h(time)}" errorStyleClass="err" /></td>
						<td>
						<html:select property="processCode" style="width: 100%;" errorStyleClass="err" >
		...
		<!-- ↓持込承認内容入力フォーム↓ -->
		<c:if test="${(authorizations == 1) && (h.conditionCode==10 || h.conditionCode==12)}">
			<ul>
			<html:errors property="bringApprovalDate" />
			<html:errors property="bringApproveNotes" /></ul>
				...
				<table border="1">
					...
					<tr>
						...
						<td><html:text styleClass="hankaku" maxlength="8" property="bringApprovalDate"
							value="${f:h(time)}" errorStyleClass="err" /></td>
						<td class="none"></td>
					</tr>
					<tr>
						<th>持込確認時備考</th>
					...
					<tr>
						...
						<html:textarea property="bringApproveNotes" style="ime-mode: active;" errorStyleClass="err" >${f:h(h.bringApproveNotes)}</html:textarea>
						</td>
					</tr>
				</table>
		...
		<c:if test="${(authorizations == 1) && h.conditionCode==20}">
			...
			<ul>
			<html:errors property="processApprovalDate" />
			<html:errors property="processApproveNotes" />
			</ul>
			<s:form>
				...
				<table border="1">
					...
					<tr>
						...
						<td><html:text property="processApprovalDate" value="${f:h(time)}" styleClass="hankaku" maxlength="8" errorStyleClass="err" /></td>
						<td class="none"></td>
					<tr>
					...
					<tr>
						<td class="notes" colspan="3"><html:textarea property="processApproveNotes" style="imemode: active;" errorStyleClass="err">${f:h(h.processApproveNotes)}</html:textarea>
						</td>
					</tr>
				</table>
